        ...
        while (true) {
            ...
            switch (opcao) {
                ...
                case 2:
                    ...
                    break;
          /*      case 3:
                    System.out.print("Descrição do produto para adicionar estoque: ");
                    String descricaoAdicionar = scanner.nextLine();
                   // Produto produtoAdicionar = gerenciador.encontrarProduto(descricaoAdicionar);
                    if (produtoAdicionar != null) {
                        System.out.print("Quantidade de produto a adicionar: ");
                        int qtdAdicionar = scanner.nextInt();
                        produtoAdicionar.adicionarEstoque(qtdAdicionar);
                    } else {
